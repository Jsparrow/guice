  ...
  public void testAssistedFactory() {
	...
	public void testAssistedInjectConstructorAndAssistedFactoryParameterMustNotMix() {
	    try {
	      ...
	      assertContains(
	          expected.getMessage(),
	          new StringBuilder().append("Factory method ").append(AssistedParamsFactory.class.getName()).append(".create() has an @Assisted parameter, which ").append("is incompatible with the deprecated @AssistedInject annotation.").toString());
	    }
	  }
