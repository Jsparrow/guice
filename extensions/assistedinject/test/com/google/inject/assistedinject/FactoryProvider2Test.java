  ...
  public void testAssistedFactory() {
	...
	public void testFactoryFailsWithMissingBinding() {
	    try {
	      ...
	      assertContains(
	          ...
	          new StringBuilder().append("at ").append(ColoredCarFactory.class.getName()).append(".create(FactoryProvider2Test.java").toString());
	    }
	  }
	...
	public void testAssistedProviderIsDisallowed() {
	    try {
	      ...
	      assertContains(
	          expected.getMessage(),
	          new StringBuilder().append(") A Provider may not be a type in a factory method of an AssistedInject.").append("\n  Offending instance is parameter [1] with key").append(" [com.google.inject.Provider<").append(Color.class.getName()).append(">] on method [").append(ProviderBasedColoredCarFactory.class.getName())
					.append(".createCar()]").toString());
	      assertContains(
	          expected.getMessage(),
	          new StringBuilder().append(") A Provider may not be a type in a factory method of an AssistedInject.").append("\n  Offending instance is parameter [2] with key").append(" [com.google.inject.Provider<java.lang.String>] on method [").append(ProviderBasedColoredCarFactory.class.getName()).append(".createCar()]").toString());
	      assertContains(
	          expected.getMessage(),
	          new StringBuilder().append(") A Provider may not be a type in a factory method of an AssistedInject.").append("\n  Offending instance is parameter [1] with key").append(" [com.google.inject.Provider<").append(Color.class.getName()).append(">").append(" annotated with @com.google.inject.assistedinject.Assisted(value=")
					.append(Annotations.memberValueString("color")).append(")]").append(" on method [").append(ProviderBasedColoredCarFactory.class.getName()).append(".createMustang()]").toString());
	      assertContains(
	          expected.getMessage(),
	...
	public void testAssistedJavaxProviderIsDisallowed() {
	    try {
	      ...
	      assertContains(
	          expected.getMessage(),
	          new StringBuilder().append(") A Provider may not be a type in a factory method of an AssistedInject.").append("\n  Offending instance is parameter [1] with key").append(" [com.google.inject.Provider<").append(Color.class.getName()).append(">] on method [").append(JavaxProviderBasedColoredCarFactory.class.getName())
					.append(".createCar()]").toString());
	      assertContains(
	          expected.getMessage(),
	          new StringBuilder().append(") A Provider may not be a type in a factory method of an AssistedInject.").append("\n  Offending instance is parameter [2] with key").append(" [com.google.inject.Provider<java.lang.String>] on method [").append(JavaxProviderBasedColoredCarFactory.class.getName()).append(".createCar()]").toString());
	      assertContains(
	          expected.getMessage(),
	          new StringBuilder().append(") A Provider may not be a type in a factory method of an AssistedInject.").append("\n  Offending instance is parameter [1] with key").append(" [com.google.inject.Provider<").append(Color.class.getName()).append(">").append(" annotated with @com.google.inject.assistedinject.Assisted(value=")
					.append(Annotations.memberValueString("color")).append(")]").append(" on method [").append(JavaxProviderBasedColoredCarFactory.class.getName()).append(".createMustang()]").toString());
	      assertContains(
	          expected.getMessage(),
	          ") No implementation for com.google.inject.assistedinject."
	...
	public void testDuplicateKeys() {
	    try {
	      ...
	      assertContains(
	          expected.getMessage(),
	          new StringBuilder().append("A binding to ").append(Color.class.getName()).append(" annotated with @").append(Assisted.class.getName()).append("(value=").append(Annotations.memberValueString("paint"))
					.append(") was already configured at").toString());
	    }
	  }
...
public interface Car {}
  ...
  public interface MustangInsuranceFactory {
    Insurance<Mustang> create(Mustang car, double premium);
  }

  public interface CamaroInsuranceFactory {
    Insurance<Camaro> create(Camaro car, double premium);
  }

  public interface InsuranceFactory<T extends Car> {
    Insurance<T> create(T car, double premium);
  }
