  ...
  public static final Red RED =
	...
	public void testInjectingFinalFieldsIsForbidden() {
	    try {
	      ...
	      assertContains(
	          expected.getMessage(), new StringBuilder().append("1) Injected field ").append(L.class.getName()).append(".b cannot be final.").toString());
	    }
	  }
	...
	public void testInjectingAbstractMethodsIsForbidden() {
	    try {
	      ...
	      assertContains(
	          expected.getMessage(),
	          new StringBuilder().append("1) Injected method ").append(AbstractM.class.getName()).append(".setB() cannot be abstract.").toString());
	    }
	  }
	...
	public void testInjectingMethodsWithTypeParametersIsForbidden() {
	    try {
	      ...
	      assertContains(
	          expected.getMessage(),
	          new StringBuilder().append("1) Injected method ").append(N.class.getName()).append(".setB() cannot declare type parameters of its own.").toString());
	    }
	  }
	...
	public void testGuicifyWithDependencies() {
	    Provider<String> jsr330Provider =
	        new Provider<String>() {
	          ...
	          @Override
	          public String get() {
	            return new StringBuilder().append(d).append("-").append(i).toString();
	          }
	        };
