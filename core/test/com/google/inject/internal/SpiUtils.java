  ...
  /**
	...
	@SuppressWarnings("unchecked")
	  private static <T> void mapInjectorTest(
	    ...
	    assertEquals(
	        new StringBuilder().append("wrong entries, expected: ").append(mapResults).append(", but was: ").append(entries).toString(),
	        mapResults.size(),
	        entries.size());
	    ...
	    for (MapResult result : mapResults) {
	      ...
	      if (found == null) {
	        fail(new StringBuilder().append("Could not find entry: ").append(result).append(" in remaining entries: ").append(entries).toString());
	      } else {
	        assertTrue(
	    ...
	    if (!entries.isEmpty()) {
	      fail(new StringBuilder().append("Found all entries of: ").append(mapResults).append(", but more were left over: ").append(entries).toString());
	    }
	...
	@SuppressWarnings("unchecked")
	  private static <T> void mapModuleTest(
	    ...
	    for (MapResult<?, ?> result : mapResults) {
	      ...
	      assertTrue(
	          new StringBuilder().append("Could not find entry: ").append(result).append(" in remaining entries: ").append(entries).toString(),
	    ...
	    assertTrue(
	        new StringBuilder().append("Found all entries of: ").append(mapResults).append(", but more were left over: ").append(entries).toString(),
	        entries.isEmpty());
	...
	@SuppressWarnings("unchecked")
	  private static <T> void setInjectorTest(
	    ...
	    assertEquals(
	        new StringBuilder().append("wrong bind elements, expected: ").append(bindResults).append(", but was: ").append(multibinder.getElements()).toString(),
	        bindResults.size(),
	        elements.size());
	    ...
	    for (BindResult result : bindResults) {
	      ...
	      if (found == null) {
	        fail(new StringBuilder().append("Could not find element: ").append(result).append(" in remaining elements: ").append(elements).toString());
	      } else {
	    ...
	    if (!elements.isEmpty()) {
	      fail(new StringBuilder().append("Found all elements of: ").append(bindResults).append(", but more were left over: ").append(elements).toString());
	    }
	...
	@SuppressWarnings("unchecked")
	  private static <T> void setModuleTest(
	    ...
	    Visitor<T> visitor = new Visitor<>();
	    MultibinderBinding<Set<T>> multibinder = elements.stream().filter(element -> element instanceof Binding && ((Binding) element).getKey().equals(setKey)).findFirst().map(element -> (MultibinderBinding<Set<T>>) ((Binding) element).acceptTargetVisitor(visitor)).orElse(null);
	    assertNotNull(multibinder);
	...
	@SuppressWarnings({"unchecked", "rawtypes"})
	  private static <T> void optionalInjectorTest(
	    ...
	    if (expectedDefault == null) {
	      ...
	      assertTrue(
	          new StringBuilder().append("expectedDefault: ").append(expectedDefault).append(", actualDefault: ").append(optionalBinder.getDefaultBinding()).toString(),
	          matches(optionalBinder.getDefaultBinding(), expectedDefault));
	      assertTrue(
	          new StringBuilder().append("expectedDefault: ").append(expectedDefault).append(", actualDefault: ").append(javaOptionalBinder.getDefaultBinding()).toString(),
	    ...
	    if (expectedActual == null && expectedUserLinkedActual == null) {
	      ...
	      assertTrue(
	          new StringBuilder().append("expectedActual: ").append(expectedActual).append(", actualActual: ").append(optionalBinder.getActualBinding()).toString(),
	          matches(optionalBinder.getActualBinding(), expectedActual));
	      assertTrue(
	          new StringBuilder().append("expectedActual: ").append(expectedActual).append(", actualActual: ").append(javaOptionalBinder.getActualBinding()).toString(),
	          matches(javaOptionalBinder.getActualBinding(), expectedActual));
	
	    } else if (expectedUserLinkedActual != null) {
	      assertTrue(
	          new StringBuilder().append("expectedUserLinkedActual: ").append(expectedUserLinkedActual).append(", actualActual: ").append(optionalBinder.getActualBinding()).toString(),
	          matches(optionalBinder.getActualBinding(), expectedUserLinkedActual));
	      assertTrue(
	          new StringBuilder().append("expectedUserLinkedActual: ").append(expectedUserLinkedActual).append(", actualActual: ").append(javaOptionalBinder.getActualBinding()).toString(),
	    ...
	    for (Element element : elements) {
	      ...
	      if (key != null && key.equals(keyType)) {
	        ...
	        if (b != null) { // otherwise it might just be a ProviderLookup into it
	          assertTrue(
	              new StringBuilder().append("expected: ").append(expectedDefault).append(", but was: ").append(b).toString(), matches(b, expectedDefault));
	          defaultMatch = true;
	        }
	      } else if (key != null && key.equals(actualKey)) {
	        assertTrue(contains);
	        if (b != null) { // otherwise it might just be a ProviderLookup into it
	          assertTrue(new StringBuilder().append("expected: ").append(expectedActual).append(", but was: ").append(b).toString(), matches(b, expectedActual));
	          actualMatch = true;
	        }
	      } else if (contains) {
	        otherContains.add(element);
	...
	static <T> BindResult<T> instance(T t) {
	    return new BindResult<>(INSTANCE, t, null);
	  }

	static <T> BindResult<T> linked(Class<? extends T> clazz) {
	    return new BindResult<>(LINKED, null, Key.get(clazz));
	  }

	static <T> BindResult<T> linked(Key<? extends T> key) {
	    return new BindResult<>(LINKED, null, key);
	  }

	static <T> BindResult<T> providerInstance(T t) {
	    return new BindResult<>(PROVIDER_INSTANCE, t, null);
	  }

	static <T> BindResult<T> providerKey(Key<T> key) {
	    return new BindResult<>(PROVIDER_KEY, null, key);
	  }
...
static class MapResult<K, V> {
    ...
    public String toString() {
      return new StringBuilder().append("entry[key[").append(k).append("],value[").append(v).append("]]").toString();
    }
  }
  ...
  static class BindResult<T> {
    ...
    public String toString() {
      switch (type) {
        case INSTANCE:
          return new StringBuilder().append("instance[").append(instance).append("]").toString();
        case LINKED:
          return new StringBuilder().append("linkedKey[").append(key).append("]").toString();
        case PROVIDER_INSTANCE:
          return new StringBuilder().append("providerInstance[").append(instance).append("]").toString();
        case PROVIDER_KEY:
          return new StringBuilder().append("providerKey[").append(key).append("]").toString();
      }
      return null;
    }
  }
