...
public class TypeConversionTest extends TestCase {
  ...
  public void testOneConstantInjection() {
	    Injector injector =
	...
	public void testConstantInjectionWithExplicitBindingsRequired() {
	    Injector injector =
	        Guice.createInjector(
	            new AbstractModule() {
	              @Override
	...
	public void testInvalidInteger() {
	    ...
	    try {
	      ...
	      assertContains(
	          expected.getMessage(),
	          new StringBuilder().append("Error converting 'invalid' (bound at ").append(InnerErrorModule.class.getName()).append(getDeclaringSourcePart(getClass())).toString(),
	...
	public void testToInstanceIsTreatedLikeConstant() {
	    Injector injector =
	        Guice.createInjector(
	            new AbstractModule() {
	              @Override
	...
	public void testInvalidCustomValue() {
	    ...
	    try {
	      ...
	      assertContains(
	          ...
	          new StringBuilder().append("at ").append(DateHolder.class.getName()).append(".date(TypeConversionTest.java:").toString());
	    }
	  }
	...
	public void testAmbiguousTypeConversion() {
	    try {
	      ...
	      assertContains(
	          ...
	          "to java.util.Date:",
	          new StringBuilder().append("CustomConverter which matches only(java.util.Date) (bound at ").append(Ambiguous1Module.class.getName()).append(getDeclaringSourcePart(getClass())).toString(),
	          asModuleChain(
	              OuterAmbiguousModule.class, InnerAmbiguousModule.class, Ambiguous1Module.class),
	          "and",
	          new StringBuilder().append("CustomConverter which matches only(java.util.Date) (bound at ").append(Ambiguous2Module.class.getName()).append(getDeclaringSourcePart(getClass())).toString(),
	          asModuleChain(
