...
public class ParentInjectorTest extends TestCase {
  ...
  /*if[AOP]*/
	...
	private final TypeConverter listConverter =
	      (String value, TypeLiteral<?> toType) -> ImmutableList.of();
	...
	public void testParentJitBindingWontClobberChildBinding() {
	    ...
	    try {
	      ...
	      assertContains(
	          ...
	          new StringBuilder().append("bound at ").append(bindsA.getClass().getName()).append(".configure(").toString(),
	...
	public void testChildCannotBindToAParentJitBinding() {
	    ...
	    try {
	      ...
	      assertContains(
	          ...
	          new StringBuilder().append("A just-in-time binding to ").append(A.class.getName()).append(" was already configured on a parent injector.").toString());
	    }
	  }
	...
	public void testScopeBoundInChildInjectorOnly() {
	    ...
	    try {
	      ...
	      assertContains(
	          ...
	          new StringBuilder().append("at ").append(F.class.getName()).append(".class(ParentInjectorTest.java").toString(),
