  ...
  @SuppressWarnings("unused")
	...
	public void testArrayKeys_unwrapValuesTrue() {
	    ...
	    try {
	      ...
	      assertContains(
	          ...
	          new StringBuilder().append("at ").append(m.getClass().getName()).append(".provideFoo(").toString());
	    }
	  }
	...
	public void testProvidesIntoSetWithMapKey() {
	    ...
	    try {
	      ...
	      assertContains(
	          ce.getMessage(),
	          new StringBuilder().append("Found a MapKey annotation on non map binding at ").append(m.getClass().getName()).append(".provideFoo").toString());
	    }
	  }
	...
	public void testProvidesIntoMapWithoutMapKey() {
	    ...
	    try {
	      ...
	      assertContains(
	          ce.getMessage(),
	          new StringBuilder().append("No MapKey found for map binding at ").append(m.getClass().getName()).append(".provideFoo").toString());
	    }
	  }
	...
	public void testMoreThanOneMapKeyAnnotation() {
	    ...
	    try {
	      ...
	      assertContains(
	          ce.getMessage(),
	          new StringBuilder().append("Found more than one MapKey annotations on ").append(m.getClass().getName()).append(".provideFoo").toString());
	    }
	  }
