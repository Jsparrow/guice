	          ...
	          new Converter<Key>(Key.class) {
	            ...
	            public String toString(Key key) {
	              if (key.getAnnotationType() != null) {
	                return new StringBuilder().append(key.getTypeLiteral()).append(" annotated with ").append(key.getAnnotation() != null ? key.getAnnotation() : key.getAnnotationType()).toString();
	              } else {
